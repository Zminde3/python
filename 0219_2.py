...
for row in cursor.fetchall():
    print(f"\033[1;34mVardas: \033[31m{row[0]}\033[0m")
    print(f"\033[1;34mPavardė: \033[32m{row[1]}\033[0m")
    print(f"\033[1;34mDalykas: \033[34m{row[2]}\033[0m")
    print(f"\033[1;34mAtlyginimas: \033[35m{row[3]}\033[0m\n")
